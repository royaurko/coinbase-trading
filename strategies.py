...
def cppi(portfolio_value, floor, log, account, multiplier=3, currency='USD', flag='n'):
...
def cppi_rebalance(portfolio_value, floor, interval, log, account, multiplier=3, currency='USD', flag='n'):
    pvalue = portfolio_value
    while True:
        bitcoin_investment = cppi(pvalue, floor, log, account, multiplier, currency, flag)
...
if __name__ == '__main__':
    ...
    cppi_rebalance(initial_pvalue, floor, interval, log, my_account[0], multiplier, currency, flag)
